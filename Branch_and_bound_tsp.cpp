...
int main()
{
    int costMatrix[N][N] =
    {
        {INF,383,886,777,915,793,335,386,492,649},
        {421,INF,362,27,690,59,763,926,540,426},
        {172,736,INF,211,368,567,429,782,530,862},
        {123,67,135,INF,929,802,22,58,69,167},
        {393,456,11,42,INF,229,373,421,919,784},
        {537,198,324,315,370,INF,413,526,91,980},
        {956,873,862,170,996,281,INF,305,925,84},
        {327,336,505,846,729,313,857,INF,124,895},
        {582,545,814,367,434,364,43,750,INF,87},
        {808,276,178,788,584,403,651,754,399,INF}

    };

    auto start = high_resolution_clock::now(); 
    cout <<"For the "<<solve(costMatrix)<<" is the cost.";
